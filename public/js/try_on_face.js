...
var TryOnFace = function (params) {
    ...
    */
	...
	scene.add(lightRight);
	{
		...
		gltfLoader.load('glasses/lastoutput.glb', (gltf) => {
		 
		  const root = gltf.scene;
		  objex=root
		  var sag_sap_1=objex.children[0].children[0].children[0].children[0].children[0];
		  var sag_sap_2=objex.children[0].children[0].children[0].children[0].children[1];
		  var sag_sap_3=objex.children[0].children[0].children[0].children[0].children[2];

		  var sol_sap_1=objex.children[0].children[0].children[0].children[0].children[3];
		  var sol_sap_2=objex.children[0].children[0].children[0].children[0].children[4];
		  var sol_sap_3=objex.children[0].children[0].children[0].children[0].children[5];
	...
	if(ref.data)
	{
	    ...
	    objex.position.x=this.position.x;
	    objex.position.y=this.position.y;
		objex.position.z=this.position.z-100;

	    objex.rotation.x = this.rotation.x;
	    objex.rotation.y = this.rotation.y;
	    objex.rotation.z = this.rotation.z;		
		...
		console.log(objex.rotation.y)
           
          
		if (objex.rotation.y>0.06)
		{
			objex.children[0].children[0].children[0].children[0].children[0].visible=false;
			objex.children[0].children[0].children[0].children[0].children[1].visible=false;
			objex.children[0].children[0].children[0].children[0].children[2].visible=false;

		}
		else
		{
			objex.children[0].children[0].children[0].children[0].children[0].visible=true;
			objex.children[0].children[0].children[0].children[0].children[1].visible=true;
			objex.children[0].children[0].children[0].children[0].children[2].visible=true;
		}
		

		if (objex.rotation.y<-0.02)
		{
			objex.children[0].children[0].children[0].children[0].children[3].visible=false;
			objex.children[0].children[0].children[0].children[0].children[4].visible=false;
			objex.children[0].children[0].children[0].children[0].children[5].visible=false;

		}
		else
		{
			objex.children[0].children[0].children[0].children[0].children[3].visible=true;
			objex.children[0].children[0].children[0].children[0].children[4].visible=true;
			objex.children[0].children[0].children[0].children[0].children[5].visible=true;
		}
